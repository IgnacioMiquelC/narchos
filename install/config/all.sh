...
run_logged $NARCHOS_INSTALL/config/git.sh
run_logged $NARCHOS_INSTALL/config/gpg.sh
run_logged $NARCHOS_INSTALL/config/timezones.sh
run_logged $NARCHOS_INSTALL/config/increase-sudo-tries.sh
run_logged $NARCHOS_INSTALL/config/increase-lockout-limit.sh
run_logged $NARCHOS_INSTALL/config/ssh-flakiness.sh
run_logged $NARCHOS_INSTALL/config/detect-keyboard-layout.sh
run_logged $NARCHOS_INSTALL/config/xcompose.sh
run_logged $NARCHOS_INSTALL/config/mise-work.sh
run_logged $NARCHOS_INSTALL/config/fix-powerprofilesctl-shebang.sh
...
run_logged $NARCHOS_INSTALL/config/hardware/bluetooth.sh
run_logged $NARCHOS_INSTALL/config/hardware/printer.sh
